...
function initAdmin(socket) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default().get('/admin/orders', {
    ...
    orders = res.data; //admin request all the dat anad populate it to the orders and display it ot front page using the innerhtml
...
var addToCart = document.querySelectorAll('.add-to-cart'); //By class    //the button Add when we click

var cartCounter = document.querySelector('#cartCounter'); //By id
...
if (adminAreaPath.includes('admin')) {
  //if it is the admin page then on;y this works
  (0,_admin__WEBPACK_IMPORTED_MODULE_3__.initAdmin)(socket); //pass socket to admin page to be used 
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51JHQflSCaXRC5YS9K0D8MHnHHI2V9Di0nldVjEKWCn56UWojsOt4unw6lUuF3ZxTqz04NO1opiWmq64vut7RLmGL00v8LCX0dj');
          ...
          case 7:
            paymentType.addEventListener('change', function (e) {
              if (e.target.value === 'card') {
                //Display Widget
                card = new _CardWidget__WEBPACK_IMPORTED_MODULE_3__.CardWidget(stripe); //CALL THE CALSSwe created
